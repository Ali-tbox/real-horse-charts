...
function StrideSymmetryGraph({ checkValue, handleItemClick, deficitLabel, selectedItem, leftData, rightData, color1, color2, text, type }) {
  console.log('rightData', deficitLabel, rightData)
  return (
    <Box
      display={'flex'}
      ...
      <Box>
        <Box maxW={'100%'} height='136px'>
          <BarChart
            ...
            leftData={deficitLabel <= checkValue ? 100 : leftData}
            rightData={deficitLabel <= checkValue ? 100 : rightData}
            color1={color1}
            color2={color2}
          />
        </Box>
